...
<head>
    ...
    label {
        @apply block uppercase text-slate-700 font-medium text-sm mb-2;
    }

    input, textarea {
        @apply shadow-sm appearance-none border w-full py-2 px-3 text-slate-700 leading-tight focus:outline-none focus:ring-1 focus:ring-slate-700 focus:border-slate-700;
    }
